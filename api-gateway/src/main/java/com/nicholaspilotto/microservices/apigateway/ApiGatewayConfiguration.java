package com.nicholaspilotto.microservices.apigateway;
...
@Configuration public class ApiGatewayConfiguration {
  @Bean public RouteLocator gatewayRouter(RouteLocatorBuilder builder) {
    ...
    return builder.routes()
        ...
        .route(predicateSpec -> {
          return predicateSpec.path("/currency-exchange/**")
              .uri("lb://currency-exchange");
        })
        .route(predicateSpec -> {
          return predicateSpec.path("/currency-conversion/**")
              .uri("lb://currency-conversion");
        })
        .route(predicateSpec -> {
          return predicateSpec.path("/currency-conversion-feign/**")
              .uri("lb://currency-conversion");
        })
        .route(predicateSpec -> {
          return predicateSpec.path("/currency-conversion-new/**")
