package com.nicholaspilotto.microservices.currencyconversionservice.dao;
...
public class CurrencyConversion {
  ...
  public String toString() {
    return "CurrencyConversion{" + "id=" + id + ", from='" + from + '\'' + ", to='" + to + '\'' + ", conversionMultiple=" + conversionMultiple + ", quantity=" + quantity + ", totalCalculateAmount=" + totalCalculateAmount + ", environment='" + environment + '\'' + '}';
  }
}
